...
with tarfile.open(f'{args.OutputFolder}/dlm_results.tgz', 'w:gz') as tar:
    for x in observables:
        tar.add(f'{args.OutputFolder}/{x.descriptor}_sweep.dat', arcname = f'{x.descriptor}_sweep.dat')
