...
measurement.logger.addHandler(handler2)
...
precisions = {nmol_obs: 1, energy_obs: 0.5}
...
measurement_template = measurement.Measurement(interface, observables, maxsims=5, maxtime=30, precisions=precisions)
